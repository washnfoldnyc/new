...
export const metadata: Metadata = {
  title: 'Blog | NYC Cleaning Tips & News | Wash and Fold NYC',
  description: 'Wash and Fold NYC blog — cleaning tips, guides & news for NYC residents. Apartment care, eco-friendly products & pro advice. Service from $3/lb. (917) 970-6002',
  alternates: { canonical: 'https://www.washandfoldnyc.com/nyc-wash-and-fold-blog' },
  openGraph: {
    title: 'Blog | Wash and Fold NYC',
    description: 'Expert cleaning tips and guides for NYC residents.',
    url: 'https://www.washandfoldnyc.com/nyc-wash-and-fold-blog',
  },
  twitter: {
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-[#1a3a5c] to-[#2B7BB0] py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <h1 className="font-[family-name:var(--font-bebas)] text-4xl md:text-5xl lg:text-6xl text-white tracking-wide mb-4">Wash and Fold NYC Blog</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <Breadcrumbs items={[{ name: 'Blog', href: '/nyc-wash-and-fold-blog' }]} />

        {/* Featured post */}
        <Link href={`/nyc-wash-and-fold-blog/${featured.slug}`} className="group block border border-gray-200 rounded-xl p-8 md:p-10 mb-12 hover:border-[#4BA3D4] hover:shadow-lg transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {rest.map(post => (
            <Link key={post.slug} href={`/nyc-wash-and-fold-blog/${post.slug}`} className="group border border-gray-200 rounded-xl p-6 hover:border-[#4BA3D4] hover:shadow-lg transition-all">
